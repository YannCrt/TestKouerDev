            ...
            <div className="min-[900px]:flex justify-between items-center gap-4 p-4 border-gray border-b-1">
                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="hidden min-[360px]:flex min-[1100px]:hidden items-center gap-2 px-4 sm:px-6 py-3 bg-green text-white rounded-3xl hover:bg-green-600 transition-colors"
                    >
